...
export const strings = {
  ...
  onboardingScreen: {
    ...
    newItem14: "\nריקים מאדם",
    newItem15: " או",
    newItem16: " עמוסים במבקרים ",
    newItem2: "דווחו",
    newItem21: " על מצב הניקיון והעומס\nבמבקרים ועזרו למטיילים אחרים\nלטייל חכם ולנו לשפר את מצב הטבע.",
    newItem3: `התקדמו`,
    newItem31: ` עם כל דיווח בסולם\nהמעורבות של ״בשביל הטבע״.`,
    done: "השתמשו בנקודות שצברתם" + "\n" + "כדי לגלות מהו עומס המבקרים" + "\n" + "באתר בו תרצו לטייל",
    coolButton: "מגניב",
  },
  placeScreen: {
    ...
    crowdnessTitle: (small) => {
      return small ? `עומס מטיילים בסופ"ש` : `עומס מבקרים בסופ"ש`;
    },
  ...
  loginScreen: {
    ...
    emailSentDesc: "קוד אימות נשלח אליכם למייל," + "\n" + "אנא הזינו אותו בשלב הבא ובחרו סיסמה חדשה.",
  ...
  reportScreen: {
    ...
    cleanTitles: ["ממש מלוכלך", "קצת מלוכלך", "ככה ככה", "נקי", "ממש נקי"],
    crowdTitle: "מה מצב עומס\nהמבקרים במקום?",
    crowdTitles: ["עמוס מאוד", "עמוס", "סביר", "מעט אנשים", "ריק מאדם"],
    otherPeople: (num) => {
      if (num === 0) {
